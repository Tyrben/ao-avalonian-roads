...
xidel /mnt/d/git/autres/ao-bin-dumps/cluster/world.xml -e '/world/clusters/cluster[ fn:matches(@id, "^[0-9]{4}$") ]/exits/exit[fn:matches(@targettype, "^Cluster$")]/fn:concat(../../@id, ";", fn:substring-after(@targetid, "@"))'